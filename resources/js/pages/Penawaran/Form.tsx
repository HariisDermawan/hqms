...
import type { Penawaran, PenawaranPayload } from '@/api/penawaran';

interface PenawaranFormProps {
    initial?: Penawaran | null;
    processing: boolean;
    errors?: Record<string, string | undefined> & {
        general?: string;
    };
    onSubmit: (payload: PenawaranPayload, image?: File) => void;
}
        ...
        >
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div className="sm:col-span-2">
                    <span className={labelClass}>Gambar</span>
                ...
                <div className="sm:col-span-2">
                    ...
                    <input
                        ...
                        placeholder="Contoh: Promo Paket Medical Check-Up"
                ...
                <div className="sm:col-span-2">
                    ...
                    <p className="mt-1 text-[11px] text-gray-400">
                        Huruf kecil dan tanda strip (-), tanpa spasi.
                    </p>
                ...
                <div className="sm:col-span-2">
                    ...
                    <textarea
                        ...
                        placeholder="Isi detail penawaran"
                        rows={5}
