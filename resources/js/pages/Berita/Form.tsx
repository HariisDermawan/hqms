...
import type { Berita, BeritaPayload } from '@/api/berita';
...
interface BeritaFormProps {
    ...
    onSubmit: (payload: BeritaPayload, image?: File) => void;
}
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div className="sm:col-span-2">
                    ...
                    <input
                        ...
                        placeholder="Contoh: RS Merdeka Luncurkan Layanan Baru"
                ...
                <div className="sm:col-span-2">
                    ...
                    <input
                        ...
                        placeholder="Contoh: layanan-kesehatan-digital"
                        className={inputClass}
                    />
                ...
                <div className="sm:col-span-2">
                    ...
                    <SummernoteEditor
                        ...
                        error={errors.content || errors.description}
                    />
                </div>
            </div>
